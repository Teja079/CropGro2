...
#
    ...
    newCO2Tot = 0.0
    CH4_balance = 0.0
    lamda_rho : float = -99.0
    CumCH4Emission : float = -99.0
    CumCO2Emission : float = -99.0
    CO2emission : float = -99.0
    CumNewCO2 : float = -99.0
#      REAL StorageFlux, Cum_CH4_bal,
    CH4Stored_Y : float = -99.0
    FLOOD : float = -99.0
    CH4stored : float = -99.0
...
#
        ...
        CO2Emission = min(CO2Emission, newCO2Tot)
#
