#=======================================================================
#  OPSPAM, Subroutine, C.H.Porter from Soil Water portions of OPDAY
...
def OPSPAM(CONTROL, ISWITCH, FLOODWAT, TRWU,
    ...
    import numpy as np
    from ModuleDefs import GET_Char, RunConstants as RC,NL
# !-----------------------------------------------------------------------
#       USE ModuleDefs
#       USE ModuleData
#       USE FloodModule
...
#
    ...
    REFET = GET_Char('SPAM', 'REFET')
    KCB   = GET_Char('SPAM', 'KCB')
    KE    = GET_Char('SPAM', 'KE')
    KC    = GET_Char('SPAM', 'KC')
