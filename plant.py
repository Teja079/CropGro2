...
#  PLANT, Subroutine
#
#  This routine calls plant growth routines for all non-cropgro crops.
#
#  These plant growth routines are handled differently by the main
#     program than those of CROPGRO crops.
#
#     Standardized output values are initialized by this routine and
#     may or may not be computed by each individual plant growth module.
#
...
# !     CROPGRO model
        if MODEL[0:5] == 'CRGRO':
            (CANHT, CropStatus, EORATIO, HARVRES, KSEVAP, KTRANS, MDATE, NSTRES,
             PSTRES1, PUptake, PORMIN, RLV, RWUMX, SENESCE, STGDOY, FracRts,
             UNH4, UNO3, XHLAI, XLAI)= (CROPGRO(CONTROL, ISWITCH,EOP, HARVFRAC,
                                                NH4, NO3, SOILPROP,SPi_AVAIL,ST,
                                                SW, TRWUP, WEATHER, YREND, YRPLT))
# !-----------------------------------------------------------------------
# !     Forage model
#       CASE('PRFRM')
...
# !       crop routine.
        if FixCanht and (XLAI > 0.0 or XHLAI > 0.0):
            CANHT = 0.5
            FixCanht = False
#
# !***********************************************************************
...
#
    return (CANHT, EORATIO, HARVRES, KSEVAP, KTRANS, KUptake, MDATE, NSTRES, PSTRES1,
        PUptake, PORMIN, RLV, RWUMX, SENESCE, STGDOY, FracRts, UH2O, UNH4, UNO3, XHLAI, XLAI)
# !===========================================================================
