...
def CROPGRO(CONTROL, ISWITCH,  EOP, HARVFRAC, NH4, NO3, SOILPROP, SPi_AVAIL,
    ...
    if DYNAMIC == RUNINIT:
        ...
        if CROP != 'FA':
            (
                ...
                RUNINIT, CONTROL, AGRLF, AGRRT, AGRSH2, AGRSTM, CROP, DRPP,
            ...
            (
                ...
                RUNINIT, FILECC, FILEIO, FRLF, FRRT, FRSTM
            )
            # -----------------------------------------------------------------------
            (
                TRNH4U, TRNO3U, TRNU, UNH4, UNO3
            ) = NUPTAK(
                RUNINIT, DLAYR, DUL, FILECC, KG2PPM, LL, NDMSDR, NDMTOT, NH4,
            ...
            if ISWSYM == 'Y':
                (
                    ...
                    RUNINIT, AGRNOD, CNODMN, CTONOD, DLAYR, DXR57, FILECC, FILEIO,
            ...
            (
                ...
                RUNINIT, AGRSD1, AGRSH1, DLAYR, DRPP, DUL, FILECC, FILEGC, FILEIO,
            ...
            (
                ...
                RUNINIT, AGRLF, AGRRT, AGRSTM, CMINEP, CSAVEV, DTX, DXR57, ECONO, FILECC, FILEGC,
            ...
            SLDOT, SLNDOT, SSDOT, SSNDOT = SENES(
                RUNINIT, FILECC, CLW, DTX, KCAN, NR7, NRUSLF, PAR, RHOL, SLAAD, STMWT, SWFAC,
                VSTAGE, WTLF, XLAI
            )

            # -----------------------------------------------------------------------
            RLV, RTDEP, SATFAC, SENRT, SRDOT = ROOTS(
                RUNINIT, AGRRT, CROP, DLAYR, DS, DTX, DUL, FILECC, FRRT, ISWWAT, LL, NLAYR, PG,
            ...
            (
                ...
                CONTROL, ISWITCH, RUNINIT, SOILPROP, AGEFAC, CADLF, CADST, CRUSLF, CRUSRT, CRUSSH,
    ...
    # ***********************************************************************
        ...
        (
            ...
            SEASINIT, CONTROL, AGRLF, AGRRT, AGRSH2, AGRSTM, CROP, DRPP, DXR57,
        ...
        if CROP != 'FA':
            AGRLF, AGRNOD, AGRRT, AGRSD1, AGRSD2, AGRSH1, AGRSH2, AGRSTM, AGRVG, AGRVG2, SDPROR = INCOMP(
                SEASINIT, FILECC, FILEIO, FRLF, FRRT, FRSTM
            )
        ...
        GROW(
            CONTROL, ISWITCH, SEASINIT, SOILPROP, AGEFAC, CADLF, CADST, CRUSLF, CRUSRT, CRUSSH,
        ...
        TRNH4U, TRNO3U, TRNU, UNH4, UNO3 = NUPTAK(
            SEASINIT, DLAYR, DUL, FILECC, KG2PPM, LL, NDMSDR, NDMTOT,
        ...
        NMINEA, NRUSLF, NRUSRT, NRUSSH, NRUSST = MOBIL(
            SEASINIT, NDMNEW, NMINEP, NMOBR, RPRO, TRNU,
            WNRLF, WNRRT, WNRSH, WNRST
        )

        # -----------------------------------------------------------------------
        CNOD, DWNOD, DWNODA, NDTH, NFIXN, NODGR, WTNFX, SENNOD = NFIX(
            SEASINIT, AGRNOD, CNODMN, CTONOD, DLAYR, DXR57,
        ...
        SEEDNO, SHELN, SHVAR, WSDDTN, WSHDTN, WTABRT, WTSD, WTSHE, WTSHMT, FLWN = PODS(
            SEASINIT, AGRSD1, AGRSH1, DLAYR, DRPP, DUL, FILECC, FILEGC, FILEIO, FNINL, FNINSD, FNINSH,
        ...
        # -----------------------------------------------------------------------
        SLDOT, SLNDOT, SSDOT, SSNDOT = SENES(
            SEASINIT, FILECC, CLW, DTX, KCAN, NR7, NRUSLF, PAR,
            RHOL, SLAAD, STMWT, SWFAC, VSTAGE, WTLF, XLAI
        )

        # -----------------------------------------------------------------------
        RLV, RTDEP, SATFAC, SENRT, SRDOT = ROOTS(
            SEASINIT, AGRRT, CROP, DLAYR, DS, DTX, DUL, FILECC, FRRT, ISWWAT,
    ...
    #     DAILY INTEGRATION
    # ***********************************************************************
    elif DYNAMIC == INTEGR and CROP != 'FA':
        # ***********************************************************************
        ...
        if DAS == NVEG0:
            ...
            (
                ...
                CONTROL, ISWITCH, EMERG, SOILPROP, AGEFAC, CADLF, CADST, CRUSLF,
            ...
            (
                ...
                EMERG, AGRRT, CROP, DLAYR, DS, DTX, DUL, FILECC, FRRT, ISWWAT, LL,
            ...
            (
                ...
                EMERG, CONTROL, AGRLF, AGRRT, AGRSH2, AGRSTM, CROP, DRPP, DXR57,
                FILECC, FILEGC, FILEIO, FNINSH, FRACDN, LAGSD, LNGPEG, NDLEAF,
                NSTRES, PAR, PCNL, PCNRT, PCNST, PGAVL, PUNCSD, PUNCTR, PLTPOP,
                RPROAV, RTWT, SDDES, SDNO, SDVAR, SHELN, SHVAR, STMWT, SWFAC,
                TAVG, TDUMX, TDUMX2, TGRO, TURFAC, VSTAGE, WCRLF, WCRRT, WCRST,
            ...
            (
                ...
                EMERG,AGRSD1, AGRSH1, DLAYR, DRPP, DUL, FILECC,
            ...
            (AGRVG, FRLF, FRRT, FRSTM,
             ...
             TNLEAK, WLDOTN, WRDOTN, WSDOTN) = VEGGR(
                EMERG, AGRLF, AGRRT, AGRSTM, CMINEP, CSAVEV, DTX,  # Input
        ...
        if DAS >= NVEG0:
            ...
            if ISWNIT == 'Y' and ISWSYM == 'Y':
                if VSTAGE > TTFIX:
                    CNOD, DWNOD, DWNODA, NDTH, NFIXN, NODGR, WTNFX, SENNOD = NFIX(
                        INTEGR, AGRNOD, CNODMN, CTONOD, DLAYR, DXR57,  # Input
            ...
            (
                ...
                INTEGR, AGRSD1, AGRSH1, DLAYR, DRPP, DUL, FILECC,  # Input
            ...
            (
                ...
                INTEGR, AGRLF, AGRRT, AGRSTM, CMINEP, CSAVEV, DTX,  # Input
                DXR57, ECONO, FILECC, FILEGC, FNINL, FNINR,  # Input
                FNINS, KCAN, NAVL, NDMNEW, NDMOLD,  # Input
                NFIXN, NMINEA, NR1, PAR, PCH2O, PG, PGAVL,  # Input
                PStres2, ROWSPC, RVSTGE, STMWT, TGRO,  # Input
            ...
            # -----------------------------------------------------------------------
            (SLDOT, SLNDOT, SSDOT, SSNDOT) = SENES(
                INTEGR, FILECC, CLW, DTX, KCAN, NR7, NRUSLF, PAR,  # Input
            ...
            (
                ...
                CONTROL, ISWITCH, INTEGR, SOILPROP,
        ...
        # -----------------------------------------------------------------------
        if DYNAMIC == OUTPUT or DYNAMIC == SEASEND:
            # -----------------------------------------------------------------------
            # Handle crop-specific operations
            # -----------------------------------------------------------------------
            if CROP != 'FA':
                if YRDOY == YREND and DYNAMIC == OUTPUT:
                    STGDOY[16] = YREND
    ...
    PUT('PLANT', 'CANHT',  CANHT)
    PUT('PLANT', 'CANWH',  CANWH)
    PUT('PLANT', 'DXR57',  DXR57)
    PUT('PLANT', 'EXCESS', EXCESS)
    PUT('PLANT', 'NR5',    NR5)
    PUT('PLANT', 'PLTPOP', PLTPOP)
    PUT('PLANT', 'RNITP',  RNITP)
    PUT('PLANT', 'SLAAD',  SLAAD)
    PUT('PLANT', 'XPOD',   XPOD)
