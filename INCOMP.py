...
#-----------------------------------------------------------------------
    ...
    PMINLF, PMINNO, PMINRT, PMINSD, PMINSH, PMINST = [0.0] * 6
    POALF , POANO , POART , POASD , POASH , POAST = [0.0] * 6
    PROLFI, PRORTI, PROSHI, PROSTI = [0.0] * 4
    RCH2O , RLIG  , RLIP  , RMIN  , RNO3C , ROA = [0.0] * 6
    SDLIP,  SDPRO , SDPROR, SDPROS = [0.0] * 4
