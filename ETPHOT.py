#=======================================================================
#  ETPHOT, Subroutine
#  Computes canopy daily ET (mm/d) and gross photosynthesis (g CO2/d)
#  by integrating over hourly timesteps in the day.
#-----------------------------------------------------------------------
#  Zonal ET calculations (MEEVP = 'Z') are for research purposes only
#  and are not supported in the CSM v3.9 distribution version
#-----------------------------------------------------------------------
#  Called from: SPAM
...
# MEPHO  MEEVP
# -----  -----
#  'C'   /='Z' PHOTO used for photosynthesis, WATBAL used for ET
#  'L'   /='Z' ETPHOT used for photosynthesis, WATBAL used for ET
#  'L'    'Z'  ETPHOT used for both photosynthesis and ET
#========================================================================
#
...
#     PLTPOP can change due to pest damage. CHP
        ...
        if MEEVP == 'Z':
            (CEN, DAYRAD, DLAYR2, DULE, DYABSR, DYINTR, EDAY, EOP, ETNOON, FRDFRN, LLE,
                NELAYR, NLAYR, PCABRN, PCINRN, RADN, RLV2, SALB, SHCAP, ST2, STCOND, SW2,
...
#         Increase root water uptake rate 5-fold to account for
#         instantaeous vs. daily rates and convert to mm/h.
#           RWUH = 5.0 * TRWUP * 10.0/24.0

        if MEPHO == 'L':
            (DAYPAR, DYABSP, DYINTP, FRDFPN, LMXSLN, LMXSHN, PALB, PARN, PGCO2,
                PGDAY, PGNOON, PCABPN, PCINPN, PNLSLN, PNLSHN, SLWSLN, SLWSHN, SW2) = (
                PGIND (NLAYR, PALBW, DUL2, SW))
#
#       Compute hourly rates of canopy photosynthesis and evapotranspiration
#       and sum for day (TS=24 for hourly).
#
...
# C       IF added by Bruce Kimball on 9MAR15
    ...
    return EOP, EP, ES, RWU, TRWUP
#
#=======================================================================
#  ETINP, Subroutine, N.B. Pickering, 12/12/90
#  Reads in and initializes fixed ET parameters.
#------------------------------------------------------------------------
#  Called from: ETPHOT
#  Calls:       ERROR,FIND,SOIL10
#=======================================================================
#
...
#  Calculates hourly canopy absorption of PAR and IR radiation.
#-----------------------------------------------------------------------
#  Called from: ETPHOT
#  Calls:       CANABS,LFEXTN,SHADOW
#=======================================================================
import math
...
#
#=======================================================================
#  SOIL10, Subroutine, N.B. Pickering
#  Converts from soil layers of 5,15.. cm to 10,10.. cm.
#-----------------------------------------------------------------------
#  Called from: ETIND,ETINP
#  Calls:
#=======================================================================
#
...
#
#=======================================================================
#  SOIL05, Subroutine, N.B. Pickering
#  Converts from soil layers of 10,10.. cm to 5,15.. cm.
#-----------------------------------------------------------------------
#  Called from: ETPHOT
#  Calls:
#=======================================================================
...
#
#=======================================================================
#  ETIND, Subroutine, N.B. Pickering
#  Initializes daily input variables for ET.
#-----------------------------------------------------------------------
#  Called from: ETPHOT
#  Calls:       SOIL10,TABEX
#=======================================================================
...
#=======================================================================
#  PGIND, Subroutine, N.B. Pickering
#  Initializes daily input variables for PG.
#-----------------------------------------------------------------------
