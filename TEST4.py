...
def SoilNi (CONTROL, ISWITCH,CH4_data, DRN, ES, FERTDATA, FLOODWAT, IMM,LITC, MNR, newCO2, SNOW, SOILPROP, SSOMC, ST,SW, TDFC, TDLNO, TILLVALS, UNH4, UNO3, UPFLOW, WEATHER, XHLAI,FLOODN):
#
# !-----------------------------------------------------------------------
#       USE GHG_mod
#       USE FertType_mod
