...
import Scratch.Read_HZ as rhz


# Initialize variables at the global level for Phenol RUNINIT
plme = sdepth = sdage = atemp = econo = csdvar = ppsen = ph2t5 = None
phthrs = evmodc = TB = TO1 = TO2 = TM = nprior = dltyp = ctmp = tselc = None
wsenp = nsenp = psenp = ecotyp = econam = ivrgrp = ivrtem = thvar = None
pm06 = pm09 = trifol = r1ppo = optbi = slobi = cldvar = csdvrr = cldvrr = None
mnemv1 = mnflll = mnflhm = None

#SEASINIT
fnstr = fpstr = fsw = [None] * 20
ft = fuday = [None] * 20
drpp = dtx = dxr57 = fracdn = tdumx = tdumx2 = tntfac = tntfc2 = None
crop_status = jpend = mdate = ndleaf = ndset = ndvst = nvalph = nveg0 = None
nveg1 = nr1 = nr2 = nr5 = nr7 = phzacc = rstage = stgdoy = None
seed_frac = veg_frac = yremrg = yrnr1 = yrnr2 = yrnr3 = yrnr5 = yrnr7 = None
rvstge = vstage = None


# Phenol Original Inputs/outputs
...
def PHENOL(
    ...
    :return:
    """
    # Global variable (to save between function calls)
    global plme, sdepth, sdage, atemp, econo, csdvar, ppsen, ph2t5
    global phthrs, evmodc, TB, TO1, TO2, TM, nprior, dltyp, ctmp, tselc
    global wsenp, nsenp, psenp, ecotyp, econam, ivrgrp, ivrtem, thvar, pm06, pm09
    global trifol, r1ppo, optbi, slobi, cldvar, csdvrr, cldvrr, mnemv1, mnflll, mnflhm

    global drpp, dtx, dxr57, fracdn, tdumx, tdumx2, tntfac, tntfc2
    global fnstr, fpstr, fsw, ft, fuday
    global crop_status, jpend, mdate, ndleaf, ndset, ndvst, nvalph
    global nveg0, nveg1, nr1, nr2, nr5, nr7, phzacc, rstage, stgdoy
    global seed_frac, veg_frac, yremrg, yrnr1, yrnr2, yrnr3, yrnr5, yrnr7
    global rvstge, vstage
    ...
    if dynamic == RUNINIT:
        ...
        exp_dict = {'trtNum': control.trtnum }
        cul_dict = {}
        ...
        rhz.readSPE(crop,cmodel,13, {}, {},{},{},{},
                            {}, {},leaf_dict, {}, {}, {},
                            {},CT1,CT2,CT3,spe_dict, {}, {})
        ...
        if crop != 'FA':
            ...
            nprior = [x-1 for x in spe_dict['nprior']]
            dltyp  = spe_dict['dltyp']
            ctmp   = spe_dict['ctmp']
            tselc  = [x-1 for x in spe_dict['tselc']]
        ...
        return (crop_status,dtx,dxr57,fracdn,mdate,ndleaf,ndset,nr1,nr2,nr5,nr7,
